...
SCALE_FACTOR_LINEAR = 90e8  # Facteur d'échelle pour la simulation
...
def run_simulation():
    ...
    while True:
        ...
        for object in list_of_celestial_objects:
            ...
            pygame.draw.circle(screen, object.color, translate_coordinates(object, width, height), object.radius)
